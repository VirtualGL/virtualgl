...
int e_mcu_color_convert(jpgstruct *jpg, int curxmcu, int curymcu)
{
	...
	{
		case HPJ_411:
			if(jpg->flags&HPJ_BGR) ccfct=ippiBGRToYCbCr411LS_MCU_8u16s_C3P3R;
			else ccfct=ippiRGBToYCbCr411LS_MCU_8u16s_C3P3R;
			break;
		case HPJ_422:
			if(jpg->flags&HPJ_BGR) ccfct=ippiBGRToYCbCr422LS_MCU_8u16s_C3P3R;
			else ccfct=ippiRGBToYCbCr422LS_MCU_8u16s_C3P3R;
			break;
		case HPJ_444:
			if(jpg->flags&HPJ_BGR) ccfct=ippiBGRToYCbCr444LS_MCU_8u16s_C3P3R;
...
int d_mcu_color_convert(jpgstruct *jpg, int curxmcu, int curymcu)
{
	...
	{
		case HPJ_411:
			if(jpg->flags&HPJ_BGR) ccfct=ippiYCbCr411ToBGRLS_MCU_16s8u_P3C3R;
			else ccfct=ippiYCbCr411ToRGBLS_MCU_16s8u_P3C3R;
			break;
		case HPJ_422:
			if(jpg->flags&HPJ_BGR) ccfct=ippiYCbCr422ToBGRLS_MCU_16s8u_P3C3R;
			else ccfct=ippiYCbCr422ToRGBLS_MCU_16s8u_P3C3R;
			break;
		case HPJ_444:
			if(jpg->flags&HPJ_BGR) ccfct=ippiYCbCr444ToBGRLS_MCU_16s8u_P3C3R;
